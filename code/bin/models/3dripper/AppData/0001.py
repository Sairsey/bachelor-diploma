...
EXPORT_TRI=True,  EXPORT_EDGES=False,  EXPORT_NORMALS=False,  EXPORT_NORMALS_HQ=False,\
EXPORT_UV=True,  EXPORT_MTL=True,  EXPORT_COPY_IMAGES=False,\
EXPORT_APPLY_MODIFIERS=True, EXPORT_ROTX90=True, EXPORT_BLEN_OBS=True,\
EXPORT_GROUP_BY_OB=False,  EXPORT_GROUP_BY_MAT=True, EXPORT_KEEP_VERT_ORDER=False,\
				...
				if key == contextMat:
					...
					if key[0] == None and key[1] == None:
						...
						if EXPORT_GROUP_BY_MAT:
							...
							file.write('g %s\n' % ob.getData(1)) # can be mat_image or (null)
							#print ob.getData(1) + '<<<<<<>>>>>>' + ob.name
...
write('model.obj', Blender.Object.GetSelected() )
