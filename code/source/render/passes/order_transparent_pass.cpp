...
void gdr::order_transparent_pass::Initialize(void)
{
  ...
  Render->GetDevice().CompileShader(_T("bin/shaders/TransparentDiffuse.hlsl"), {}, shader_stage::Vertex, &VertexShader);
  Render->GetDevice().CompileShader(_T("bin/shaders/TransparentDiffuse.hlsl"), {}, shader_stage::Pixel, &PixelShader);
